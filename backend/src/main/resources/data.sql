...
INSERT INTO usuario(cpf, email, name, password, type) VALUES ('04309089380', 'u1@a.com', 'Amanda', '$2a$10$pXPrMAlBwA/Y8q496HP6d.S2FkYTuafMjEn8ffw6zSkmFlyBp5VG6', 'PATIENT');
INSERT INTO usuario(cpf, email, name, password, type) VALUES ('04309089380', 'u2@a.com', 'Maria', '$2a$10$pXPrMAlBwA/Y8q496HP6d.S2FkYTuafMjEn8ffw6zSkmFlyBp5VG6', 'PATIENT');
...
INSERT INTO usuario(cpf, email, name, password, type) VALUES ('04309089380', 'a@a.com', 'Ivo', '$2a$10$pXPrMAlBwA/Y8q496HP6d.S2FkYTuafMjEn8ffw6zSkmFlyBp5VG6', 'ADM');
...
INSERT INTO appointment(time, clinic_id, user_id) VALUES ({ts '2021-08-07 13:00'}, 2, 1);
...
INSERT INTO appointment(time, clinic_id, user_id) VALUES ({ts '2021-08-03 13:00'}, 2, 1);
